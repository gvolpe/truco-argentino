...
void Menu::mostrar(int op, SDL_Surface * pantalla, TTF_Font * font)
{
  ...
  {
  case 1:
    txt.mostrar(x,y,pantalla,"JUEGO NUEVO",255,255,180,255,font);
    break;
  case 2:
    txt.mostrar(x,y+dist,pantalla,"OPCIONES",255,255,180,255,font);
    break;
  case 3:
    txt.mostrar(x,y+(dist*2),pantalla,"REGLAMENTO",255,255,180,255,font);
    break;
  case 4:
    txt.mostrar(x,y+(dist*3),pantalla,"CREDITOS",255,255,180,255,font);
    break;
  case 5:
    txt.mostrar(x,y+(dist*4),pantalla,"SALIR",255,255,180,255,font);
    break;
  }
}
